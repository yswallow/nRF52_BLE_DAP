COMMON_SRC = \
  $(PROJ_SRC_DIR)/DAP/board.cpp \
  $(PROJ_SRC_DIR)/DAP/DAP_config.cpp \
  $(PROJ_SRC_DIR)/DAP/dap_vendor_command.cpp \
  $(PROJ_SRC_DIR)/DAP/JTAG_DP.cpp \
  $(PROJ_SRC_DIR)/DAP/semihost.cpp \
  $(PROJ_SRC_DIR)/DAP/SW_DP.cpp \
  $(PROJ_SRC_DIR)/DAP/DAP.cpp \
  $(PROJ_SRC_DIR)/ble/ble_hiddevice.c \
  $(SDK_ROOT)/components/ble/ble_services/ble_hids/ble_hids.c \
  $(PROJ_SRC_DIR)/raw_hid/dap_glue.c \
